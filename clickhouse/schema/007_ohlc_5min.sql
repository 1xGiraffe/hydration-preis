...
-- Purpose: Aggregate raw price data into 5-minute OHLCV candles
--
-- Target table: ohlc_5min (AggregatingMergeTree with -State aggregates)
-- Materialized view: ohlc_5min_mv (triggers on INSERT to prices table)
-- Time function: toStartOfFiveMinute (built-in ClickHouse function)
--
...
-- ============================================================================
-- Target Table: 5-Minute OHLCV Candles
-- ============================================================================

CREATE TABLE IF NOT EXISTS price_data.ohlc_5min
(
    asset_id UInt32,
...
-- ============================================================================
-- Materialized View: Auto-populate 5-Minute OHLCV from prices
-- ============================================================================
