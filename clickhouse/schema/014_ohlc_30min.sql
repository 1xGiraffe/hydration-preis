-- OHLCV 30-Minute Candles
-- Purpose: Aggregate raw price data into 30-minute OHLCV candles
--
-- Target table: ohlc_30min (AggregatingMergeTree with -State aggregates)
-- Materialized view: ohlc_30min_mv (triggers on INSERT to prices table)
-- Time function: toStartOfInterval(b.block_timestamp, INTERVAL 30 MINUTE)
--
...
-- ============================================================================
-- Target Table: 30-Minute OHLCV Candles
-- ============================================================================

CREATE TABLE IF NOT EXISTS price_data.ohlc_30min
(
    asset_id UInt32,
...
-- ============================================================================
-- Materialized View: Auto-populate 30-Minute OHLCV from prices
-- ============================================================================

CREATE MATERIALIZED VIEW IF NOT EXISTS price_data.ohlc_30min_mv
TO price_data.ohlc_30min
AS SELECT
    p.asset_id,
