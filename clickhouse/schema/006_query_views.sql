...
-- Returns: asset_id, block_height, usd_price (rounded to 8 decimals)
...
-- Returns: asset_id, block_height, usd_price (no symbol in output)
...
-- Returns: block_height, usd_price (continuous series, no gaps)
