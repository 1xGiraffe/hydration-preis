-- OHLCV 1-Month Candles
-- Purpose: Aggregate raw price data into 1-month OHLCV candles
--
-- Target table: ohlc_1m (AggregatingMergeTree with -State aggregates)
-- Materialized view: ohlc_1m_mv (triggers on INSERT to prices table)
-- Time function: toStartOfMonth(b.block_timestamp)
--
...
-- ============================================================================
-- Target Table: 1-Month OHLCV Candles
-- ============================================================================

CREATE TABLE IF NOT EXISTS price_data.ohlc_1m
(
    asset_id UInt32,
...
-- ============================================================================
-- Materialized View: Auto-populate 1-Month OHLCV from prices
-- ============================================================================

CREATE MATERIALIZED VIEW IF NOT EXISTS price_data.ohlc_1m_mv
TO price_data.ohlc_1m
AS SELECT
    p.asset_id,
