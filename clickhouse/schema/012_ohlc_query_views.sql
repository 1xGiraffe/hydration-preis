-- OHLC Query Views for Price Data Access
-- Purpose: Parameterized query views for OHLC candle data with -Merge combinators
--
-- These views hide the complexity of AggregateFunction/State/Merge operations from users.
-- Each view queries its corresponding OHLC AggregatingMergeTree table and uses -Merge
-- combinators to extract final OHLC values from -State aggregate functions.
--
...
-- ============================================================================
-- 1. 5-Minute OHLC Query View
-- ============================================================================
-- Returns OHLC candles for 5-minute intervals
...
-- ============================================================================
-- 2. 15-Minute OHLC Query View
-- ============================================================================
-- Returns OHLC candles for 15-minute intervals
...
-- ============================================================================
-- 3. 1-Hour OHLC Query View
-- ============================================================================
-- Returns OHLC candles for 1-hour intervals
...
-- ============================================================================
-- 4. 4-Hour OHLC Query View
-- ============================================================================
-- Returns OHLC candles for 4-hour intervals
...
-- ============================================================================
-- 5. 1-Day OHLC Query View
-- ============================================================================
-- Returns OHLC candles for 1-day intervals
